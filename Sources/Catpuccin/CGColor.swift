...
// 30.04.23
    ...
    private func latte(_ label: ColorLabel) -> CGColor {
        switch label {
        case .rosewater:
    ...
    private func frappe(_ label: ColorLabel) -> CGColor {
        switch label {
        case .rosewater:
    ...
    private func macchiato(_ label: ColorLabel) -> CGColor {
        switch label {
        case .rosewater:
    ...
    private func mocha(_ label: ColorLabel) -> CGColor {
        switch label {
        case .rosewater:
